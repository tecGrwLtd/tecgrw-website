...
const services = [
  {
    ...
    desc: 'smart green house , IoT sensors, and data-driven insights for sustainable yields.'
  },
  {
    title: 'AI Education',
    icon: (
    ...
    desc: 'training, Workshops and resources to empower the next generation of innovators.'
  },
  {
